    ...
    if (!battleMode) {
        ...
        for (let drawMissions = 0; drawMissions < this.MissionList.length; drawMissions++) {
            ...
            if (collision(mousex, mousey, 0, 0, 465 - 45 / 2, 40 + (60 * drawMissions), 45, 45)) {
                ...
                if (mousedown) {
                    battleInfo = this.MissionList[drawMissions];
                    this.MissionSelect = drawMissions;
                }
            }
        ...
        for (let drawTroops = 0; drawTroops < 3; drawTroops++) {
            ...
            if (battleBugs[drawTroops] !== undefined && battleBugs[drawTroops].Patrol !== this) {
                battleBugs.splice(drawTroops, 1);
                drawTroops -= 1;
            } else {
                bugBubble(50 + (125 * drawTroops), 205, 1, true, battleBugs[drawTroops] == undefined ? "+" : battleBugs[drawTroops]);
            }
        }
