...
const missions = {
    ...
    1: {
        ...
        queenFlavor: [
            ["Queen Fantasia", "Ant", "I would've never guessed a Terrachian would've made it this far. While\nour family is out here starving you thieves decided to break the contract?"],
            ["Teresa", "Termite", "It had to be done Fantasia. We couldn't take the risk of the water dwellers\nexploiting it with the blight. You know the dangers it could've caused don't you?"],
            ["Queen Fantasia", "Ant", "I do Teresa, but this cannot justify what your colony has done! Those children\n- no matter. What's done is done. I'm guessing your troops came for me?"],
            ["Queen Fantasia", "Ant", "There's nowhere to escape isn't there? You Terrachians are good at one\nthing, dying."]
        ],
    },
    2: {
        name: "Engorged Core",
    ...
    4: {
        ...
        queenFlavor: [
            ["Queen Stingeris", "Bee", "It looks like to me child you're not from around these parts? Perhaps, your\none of those Terrachians..."],
            ["Queen Stingeris", "Bee", "I wouldn't blame you, in fact I would congratulate you. Now, would you\nvillains be so kind to return our precious nectar?"]
        ],
    },
    5: {
        name: "Lament Canal",
    ...
    6: {
        ...
        queenFlavor: [
            ["Queen Lament", "Pondskater", "I would've never of thought a Terrachian would venture this far out. Listen,\nI know what you're thinking."],
            ["Queen Lament", "Pondskater", "The water dwellers aren't here to exploit the blight. In fact, the blight hasn't\neven reached us!"],
            ["Queen Lament", "Pondskater", "I know your kind, you and your lies. I would've allowed you to go peacefully."],
            ["Queen Lament", "Pondskater", "You see though, those fungi were the only food we had left. You know how\nlong it takes to grow enough to fill a cavern?"],
            ["Queen Lament", "Pondskater", "Of course you don't. If you did Fantasia and Stingeris would've still been here.\nWho am I supposed to rely on now? You?"]
        ],
    },
    7: {
        name: "Spruce Peak",
        ...
        queenFlavor: [
            ["Queen Butterfly", "Butterfly", "Who are you? Are you one of them? Please! Stay Away!"],
            ["Queen Butterfly", "Butterfly", "I'm warning you."]
        ],
    },
    8: {
        name: "Pressure Zone",
    ...
    9: {
        ...
        queenFlavor: [
            ["Queen Widow", "Spider", "Teresa? Blight? I'll tell you something - she's not who you think she is."],
            ["Queen Widow", "Spider", "You're good as dead anyway, I might as well spill the beans. Stinge-"],
            ["Queen Widow", "Spider", "Were you expecting something? I know who you are, you probably have a\nplan to crush all of us at once don't you?"],
            ["Queen Widow", "Spider", "You're in luck, at this very moment colonies are being dismantled and\ndestroyed. Nectarne is as good as gone!"]
        ],
    },
    10: {
    ...
    11: {
        ...
        queenFlavor: [
            ["Queen Centaury", "Centipede", "I've been watching your movements for quite some time. Are you wondering\nwhere this nest's farmers went?"],
            ["Queen Centaury", "Centipede", "These bugs became too reliant on others. All it would take is one siege\nto take them all down."],
            ["Queen Centaury", "Centipede", "I'm not the head of this plan, not at all. We collectively will accomplish what\nshould've happened in the first place."],
            ["Queen Centaury", "Centipede", "Would you like to see? What primordial power looks like?"]
        ],
    },
    12: {
        name: "Hadal Zone",
    ...
    13: {
        ...
        queenFlavor: [
            ["Queen Trapper", "Tarantula", "Are you looking for a way to end the blight? It's too late, we've taken out most\nof the farmers."],
    ...
    14: {
        ...
        queenFlavor: [
            ["Queen Blackjacket", "Wasp", "My my, i'm impressed with the lengths you've gone to get to me. Here you\nlowlings were thinking the blight was naturally caused!"],
            ["Queen Blackjacket", "Wasp", "It really shows how reliant you all really are. These farmers have and always\nwill be self-sufficient."],
    ...
    25: {
        ...
        queenFlavor: [
            ["???", "Millipede", "Were you expecting Centaury little one? I'm afraid she passed awhile\nago. News doesn't travel fast around these parts."],
            ["Miss Millaury", "Millipede", "I can see the gleam in your eyes. You're planning to take her brood? Aha, well\nthen. Try stopping Miss Millaury Terrachian!"]
        ],
    },
    26: {
        ...
        queenName: "Queen Blackjacket",
        queenFlavor: [
            ["Queen Blackjacket", "Wasp", "What brings you here Terrachian? Was the taste of our collective stingers\nnot enough? Perhaps, a thousand more will suffice!"]
        ],
    },
    27: {
        name: "Watery Grave",
    ...
    28: {
        ...
        queenFlavor: [
            ["Queen Draconian", "Dragonfly", "All that flies are strong. All that walk are weak. Those flies you saw, they\naren't like you. They can become better. They can do better. You, you cannot!"]
        ],
    },
    29: {
        ...
        queenName: "Queen Trapper",
        queenFlavor: [
            ["Queen Trapper", "Tarantula", "It never ceases to amaze me how you Terrachians always manage to break\nfree out of our finely crafted webs. What is it about you? Let's have a look."]
        ],
    }
}
